...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md mx-auto">
    ...
    <div class="text-center mb-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-2">Create post</h1>
      <p class="text-gray-600">Fill out the form below to get in touch with our team.</p>
    </div>

    <!-- Form -->
    <form class="bg-white shadow-md rounded-lg p-6 space-y-6" action="{{route('post.store')}}" method="post">
        @csrf
      <!-- Name Input -->
      <div>
